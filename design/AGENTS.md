...
- [mvp-acceptance.md](mvp-acceptance.md) — walking skeleton (`update_docs.glyph`), test corpus structure, 5-skill multi-file acceptance project, 80 compiler-scope + 11 agent-scope diagnostic IDs, exit criteria
