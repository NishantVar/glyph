...
- [mvp-acceptance.md](mvp-acceptance.md) — walking skeleton (`update_docs.glyph.md`), test corpus structure, 5-skill multi-file acceptance project, 72 compiler-scope + 10 agent-scope diagnostic IDs, exit criteria
