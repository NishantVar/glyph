...
| ---------------------------------------------- | -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `id: String` (e.g., `"G::analyze::missing-param-default"`) | `code: NumberOrString::String(id.clone())` | Verbatim. The ID is stable across compiler versions per `diagnostics.md` §ID Scheme — perfect as an LSP code.                                                                                                                |
