...
**FIRST ACTION — invoke the `codex:review` skill before anything else.** Call `Skill(skill: "codex:review")` now. That skill defines your review process and standards; the rest of this prompt is the issue-specific rubric layered on top of it.
