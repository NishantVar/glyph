...
export block compile_and_iterate(target = ".")
    flow:
        ...
        "Review the source diff after compilation. If repair inserted `generated const` or `generated block` definitions, decide whether each is acceptable as-is or should be promoted to hand-authored by renaming `generated const` to `const` and `generated block` to `block`."
