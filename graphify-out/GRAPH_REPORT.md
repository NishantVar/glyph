# Graph Report - lsp  (2026-05-04)

## Corpus Check
- 55 files · ~262,968 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1558 nodes · 4247 edges · 44 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 1410 edges (avg confidence: 0.8)
...
- `collect_consts()` --calls--> `infer_primitive()`  [INFERRED]
  crates/glyph-core/src/lower.rs → /Users/nishantvarshney/genesis/glyph/crates/glyph-core/src/kind_infer.rs
...
- `scan_slots()` --calls--> `analyze_skill()`  [INFERRED]
  /Users/nishantvarshney/genesis/glyph/crates/glyph-core/src/slot.rs → crates/glyph-core/src/analyze.rs
...
Cohesion: 0.02
Nodes (145): Athena tiered research wiki, Glyph Project Index, Promotion path to ./design/, Research Question: human-readable visualizable DSL, Tier: confirmed, Tier: consolidated, Tier: unconfirmed, Trust Tiers (unconfirmed -> confirmed -> consolidated -> design) (+137 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (145): analyze(), placeholder_string_return_descriptive_is_repairable_on_domain_typed_skill(), placeholder_string_return_is_repairable_on_domain_typed_skill(), ac1_directory_compile_processes_every_file(), ac1_export_text_only_library_check_source_clean(), ac1_export_text_only_library_compiles_exit_zero(), ac2_topological_order_libraries_before_consumers(), ac3_closure_violation_on_private_free_variable() (+137 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (129): analyze_with_diagnostics(), analyze_with_diagnostics_receives_enable_effects(), analyze_with_resolutions(), analyze_with_resolutions_records_block_call_target(), analyze_with_resolutions_records_text_constraint(), analyze_with_resolutions_stdlib_call_marked_stdlib(), analyze_with_resolutions_unresolved_call_no_resolution(), check_ids() (+121 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (108): Skill, block_call_site_carries_callee_output_contract_object(), emit_is_byte_identical_across_runs_with_output_contract(), find_block_by_name(), find_call(), inline_block_call_site_carries_callee_output_contract_object(), ir_json(), ir_json_after_expand() (+100 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (110): activate(), ac1_cross_file_resolution(), ac2_circular_import_path(), ac3_import_private(), ac4_import_skill(), ac5_duplicate_import_exit_2(), ac5_unused_import_exit_2(), assert_contains_diagnostic_id() (+102 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (99): placeholder_description(), placeholder_identifier(), check_accepts_directory_path(), check_default_format_is_pretty(), check_invalid_exits_one(), check_repairable_exits_two_with_diagnostic_on_stdout(), check_repairable_pretty_renders_to_stderr(), check_valid_exits_zero_and_writes_no_md() (+91 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (49): analyze_export_block(), analyze_skill(), analyze_skill_with_usage_tracking(), analyze_with_imports(), check_applies_in_condition(), check_block_return_calls(), check_branch_body_names(), check_context_entry_name() (+41 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (80): ast_rewrite(), flow_placeholder_target(), fmt_source(), fmt_source_leaves_placeholder_string_return_with_inner_escapes_unrewritten(), fmt_source_leaves_placeholder_string_return_with_inner_quotes_unrewritten(), fmt_source_preserves_placeholder_string_return_without_domain_type(), fmt_source_rewrites_descriptive_placeholder_string_return_to_output_target(), fmt_source_rewrites_placeholder_string_return_to_output_target() (+72 more)
...
Cohesion: 0.11
Nodes (26): analyze_error_roundtrip(), byte_span_to_lsp_range(), byte_span_to_range_at_origin(), byte_span_to_range_basic(), diagnostic_to_lsp(), end_position(), file_label_to_url(), missing_required_arg_roundtrip() (+18 more)
...
Cohesion: 0.2
Nodes (17): arena_with_effects(), avoid_phrasing(), avoid_phrasing_walking_skeleton(), emit(), emit_applies_arm(), emit_branch(), emit_includes_effects_when_enabled(), emit_lettered_substeps() (+9 more)
...
Cohesion: 0.12
Nodes (16): IrBlock, IrBranch, IrCall, IrConstraint, IrContext, IrElifBranch, IrInlineInstruction, IrNode (+8 more)
...
Cohesion: 0.18
Nodes (3): infer_primitive(), Literal, TypeTag
...
- **Thin community `Community 34`** (2 nodes): `Spanned<T>`, `.new()`
...
- **Thin community `Community 37`** (2 nodes): `Finding: no existing project combines custom DSL + skill abstractions + compiler + constraints + NL output`, `Log 2026-04-20: competitive landscape`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (2 nodes): `Cytoscape.js`, `vis-network`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 40`** (2 nodes): `PDL (IBM YAML prompt declaration)`, `Plang (string-first NL affinity)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (2 nodes): `Temporal struct-based params with ctx object`, `Temporal stateful function IR`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `scan_slots()` connect `Community 11` to `Community 2`, `Community 6`, `Community 7`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `compile_directory()` connect `Community 14` to `Community 2`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `validate_output()` connect `Community 4` to `Community 3`, `Community 5`?**
